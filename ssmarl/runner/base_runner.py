...
from ssmarl.utils.graph_separated_buffer import GraphSeparatedReplayBuffer
...
class Runner(object):
    def __init__(self, config):
        ...
        from ssmarl.algorithms.ssmarl.ssmarl import SSMARL as TrainAlgo
        from ssmarl.algorithms.ssmarl.algorithm.SSMARLPolicy import SSMARLPolicy as Policy
        self.policy = []
